  ...
  describe('WebDAV import with file listing', () => {
    it('should list remote files before downloading', async () => {
      ...
      (webdavList as any).mockResolvedValue([
        {
          name: 'pi-config-backup_pi-config_2026-08-17_14-30-00.json',
          path: 'Pi-Config-Sync/pi-config-backup_pi-config_2026-08-17_14-30-00.json',
          lastModified: 'Mon, 17 Aug 2026 06:30:00 GMT',
          size: 12345,
        },
        {
          name: 'pi-config-backup_pi-config_2026-08-16_10-00-00.json',
          path: 'Pi-Config-Sync/pi-config-backup_pi-config_2026-08-16_10-00-00.json',
      ...
      mockCtx.ui.select.mockResolvedValue(
        'pi-config-backup_pi-config_2026-08-17_14-30-00.json  |  modified: Mon, 17 Aug 2026 06:30:00 GMT  |  12.1 KB'
      );
      ...
      expect(mockCtx.ui.select).toHaveBeenCalledWith(
        ...
        expect.arrayContaining([
          expect.stringContaining('pi-config-backup_pi-config_2026-08-17_14-30-00.json'),
        ])
      );
      // Should download selected file
      expect(webdavDownload).toHaveBeenCalledWith(
        testConfig.webdav,
        'Pi-Config-Sync/pi-config-backup_pi-config_2026-08-17_14-30-00.json'
      );
